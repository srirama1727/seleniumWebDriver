...
public class ExtentManager {
	...
	String reportsFolder=d.toString().replaceAll(":", "-") +"//screenshots";
    	screenshotFolderPath = System.getProperty("user.dir") +"//reportsNew//"+reportsFolder;
    	String reportFolderPath = System.getProperty("user.dir") +"//reportsNew//"+d.toString().replaceAll(":", "-");
